...
Para el curso 2021-2022 se terminarán las obras de adecuación de la planta baja del edificio (Fase II), disponiendo de más espacios y materiales, además de más capacidad de alumnado. En función de la demanda para estudios de secundaria que se hubiese generado durante el curso anterior, podríamos plantear la opción de comenzar una segunda fase de obras y ocupar la totalidad del edificio o bien esperar al año siguiente para hacerlo.
